...
class QS_Admin_notices
{
    ...
    public function load_admin_scripts()
    {
        ...
        wp_register_script('qs-cf7-api-admin-notices-script', QS_CF7_API_ADMIN_JS_URL . 'admin-notices-script.js',
    ...
    public function qs_admin_notices()
    {
        if ($this->notices) {
            foreach ($this->notices as $admin_notice) {
                ...
                if (!$admin_notice['dismissable_forever'] || (!isset($this->notices_options['dismiss_notices'][$id])
                        || !$this->notices_options['dismiss_notices'][$id])) {
